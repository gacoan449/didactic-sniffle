...
class AppConfig {
  ...
  static const String tautanPlayStore = 'https://play.google.com/store/apps/details?id=com.petanidesaberkah.app';
  ...
  static final String apiUrl = dotenv.env['API_URL'] ?? 'https://api.petanidesaberkah.com';
  static const bool modePemeliharaan = false;
  static const String pesanPemeliharaan = 'Sedang perbaikan sistem, silakan coba lagi nanti';
