                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      GestureDetector(
                        onTap: () =>
                            context.push('/ubah-profil', extra: pengguna),
                        child: CircleAvatar(
                          radius: 40,
                          backgroundColor: Colors.grey[200],
                          backgroundImage: pengguna.fotoUrl.isNotEmpty
                              ? CachedNetworkImageProvider(pengguna.fotoUrl)
                              : null,
                          child: pengguna.fotoUrl.isEmpty
                              ? const Icon(
                                  Icons.person,
                                  size: 40,
                                  color: Colors.grey,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  'Aktif sejak ${DateFormat('d MMM yyyy').format(pengguna.dibuatPada)}',
                                  style: TextStyle(
                  ...
                  onPressed: () async {
                    final ok = await showDialog<bool>(
                      ...
                      builder: (c) => AlertDialog(
                        ...
                        content: const Text(
                          'Semua data lokal akan dibersihkan',
                        ),
                        actions: [
                          TextButton(
